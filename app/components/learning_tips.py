...
LEARNING_TIPS = {
    ...
    "audience": {
        ...
        "AI Insight": {
            "title": "AI Insight",
            "content": "Advanced audience intelligence generated by our proprietary AI model that analyzes behavioral patterns, content engagement, and conversion tendencies across similar audience profiles.",
            "learn_more": "Our AI insights have demonstrated 92% correlation with actual campaign performance in controlled tests."
        },
        "Interest Categories": {
