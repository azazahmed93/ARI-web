...
def header_section():
    ...
    with col1:
        ...
        <div style="background: white; border-radius: 8px; box-shadow: 0 2px 8px rgba(0,0,0,0.05); padding: 15px; text-align: center;">
            <div style="font-size: 0.7rem; text-transform: uppercase; letter-spacing: 1px; font-weight: 600; color: #5865f2;">AUDIENCE OPPORTUNITIES</div>
            <div style="font-size: 1.5rem; font-weight: 700; color: #333; margin: 5px 0;">3</div>
            <div style="font-size: 0.8rem; color: #555;">Highest-Value</div>
        </div>
        """, unsafe_allow_html=True)
